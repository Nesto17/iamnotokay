            ...
            <section className="profile__left">
                <div className="profile-left__container">
                    ...
                    <p>
                        ...
                        libero vel porttitor accumsan, nibh ex luctus metus, non aliquam quam quam
                        quis arcu. Phasellus sit. Lorem ipsum dolor sit amet, consectetur adipiscing
                        elit. Vivamus porta, libero vel porttitor accumsan, nibh ex luctus metus,
                        non
                    </p>
                ...
                <section className="profile__story">
                    <div className="profile__story--container" id="container_story">
                        ...
                        <p>
                            ...
                            quisquam harum eum fuga voluptas laboriosam ipsa voluptatem cumque optio
                            vel, ea sed impedit facere molestias cum. Rem, labore itaque? Ratione
                            unde beatae nulla cum neque facere quidem obcaecati earum veritatis,
                            doloribus qui in culpa ab voluptates vitae sequi voluptatibus
                            accusantium tempore aliquam assumenda. Similique ex ipsam, suscipit
                            fugiat necessitatibus harum possimus. Cumque velit a explicabo veniam
                            unde repellendus, totam dolorum facere asperiores, tempora, fugit
                            perspiciatis voluptatibus quibusdam iusto accusamus magnam nostrum
                            laudantium libero eum suscipit! Debitis magni, impedit omnis inventore
                            eveniet in quae ipsam ad consequuntur eaque quidem minima eius atque
                            nulla deserunt totam tempora. Eligendi laudantium quos explicabo. Minus
                            voluptatum quidem qui eos excepturi, a dolores inventore laudantium
                            vitae impedit nemo est atque, obcaecati commodi placeat repudiandae.
                            Odio voluptates quo libero nostrum? Perferendis dolorem rerum, harum
                            ullam odit quia vel alias, quos ipsum cumque culpa cum, architecto
                            nesciunt.
                        </p>
                    </div>
                    ...
                    <section className="profile__replies--list">
                        <div className="profile__replies--list--card">
                            ...
                            <p>
                                ...
                                veritatis quae est itaque corporis quos labore dolorum. Optio dolore
                                perspiciatis inventore suscipit vel natus nihil ducimus assumenda
                                quaerat voluptates.
                            </p>
                        </div>
                        <div className="profile__replies--list--card">
